...
def Train_Recognize(thresh):
    repo_path = '/home/srec/Desktop/FaceRPI/cse_device'
    ...
    while 1 > 0:
        ...
        if get_time()=="09:30" or get_time()=="20:30":
            print('time up')
            if get_time()=="09:30":
                break
            elif get_time()=="20:30":
                storage.child("/Attendance/"+get_date()+"_3.csv").put('/home/srec/Desktop/FaceRPI/data/'+get_date()+".csv")
            break
